export interface Note {
  ...
  export function saveCalendarItem(userId: string, itemId: string | null, itemData: Partial<Todo>): Promise<string>;
  
  export function deleteNote(userId: string, noteId: string, isPublic: boolean): Promise<void>;
